...
# Pattern with exactly 40 hex characters - this is critical!
echo -n "f6f5431d25bbf7b12e8add9af5e3475c44a0a5" > patterns.txt

# Verify the length is exactly 40 (no newlines or other characters)
echo "Pattern file length: $(wc -c < patterns.txt) bytes"

# Run the search with hash160 mode
echo "Running search with Hash160 mode..."
